...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { amount_paid: @submission.amount_paid, charge_id: @submission.charge_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { amount_paid: @submission.amount_paid, charge_id: @submission.charge_id } }
